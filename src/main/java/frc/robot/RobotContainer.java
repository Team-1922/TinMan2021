...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                new JoystickButton(m_XBoxController, 2) // B
                                //
                                .toggleWhenPressed(new ShootingCommand(m_Shooter, "adjustSpeed"));
                ...
                new JoystickButton(m_XBoxController, 1) // A
                             ...
                             //   .toggleWhenPressed(new DriveForward(m_driveTrain, 18));
                             .toggleWhenPressed(new SlalomAuto (m_driveTrain));
